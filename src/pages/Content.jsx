...
export default function Content() {
  ...
  return (
    <main className="page content-page">
      ...
      <section className="content-footer-panel page-panel"><div><p className="eyebrow">The {site.brand.name} Way</p><EditableField as="h2" fieldId="contentPage.footerTitle" label="Content footer title" value={page.footerTitle} policy={site.editorPolicy} /><EditableField as="p" fieldId="contentPage.footerText" label="Content footer text" value={page.footerText} policy={site.editorPolicy} kind="textarea" /></div><a className="btn primary" href={site.socials.linktree} target="_blank" rel="noreferrer">Stay Connected</a></section>
    </main>
  )
}
